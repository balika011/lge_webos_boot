...
#define DMA_LENGTH            (MSDC_BASE_ADDR + (ch * MSDC_CH_OFFSET) + 0xA8)
#endif
#if defined(CC_MT5399) || defined(CONFIG_ARCH_MT5399)|| \
    defined(CC_MT5890) || defined(CONFIG_ARCH_MT5890)|| \
    defined(CC_MT5882) || defined(CONFIG_ARCH_MT5882)
#define PATCH_BIT0            (MSDC_BASE_ADDR + (ch * MSDC_CH_OFFSET) + 0xB0)
#define PATCH_BIT1            (MSDC_BASE_ADDR + (ch * MSDC_CH_OFFSET) + 0xB4)
#else
#define PATCH_BIT             (MSDC_BASE_ADDR + (ch * MSDC_CH_OFFSET) + 0xB0)
    ...
    defined(CC_MT5890) || defined(CONFIG_ARCH_MT5890)|| \
    defined(CC_MT5882) || defined(CONFIG_ARCH_MT5882)
#define SD30_PAD_CTL0         (MSDC_BASE_ADDR + (ch * MSDC_CH_OFFSET) + 0xE0)
#define SD30_PAD_CTL1         (MSDC_BASE_ADDR + (ch * MSDC_CH_OFFSET) + 0xE4)
#define SD30_PAD_CTL2         (MSDC_BASE_ADDR + (ch * MSDC_CH_OFFSET) + 0xE8)
#else
...
#define DAT_RD_DLY0           (MSDC_BASE_ADDR + (ch * MSDC_CH_OFFSET) + 0xF0)
#define DAT_RD_DLY1           (MSDC_BASE_ADDR + (ch * MSDC_CH_OFFSET) + 0xF4)
#define HW_DBG                (MSDC_BASE_ADDR + (ch * MSDC_CH_OFFSET) + 0xF8)
#define VERSION               (MSDC_BASE_ADDR + (ch * MSDC_CH_OFFSET) + 0xFC)
#define ECO_VER               (MSDC_BASE_ADDR + (ch * MSDC_CH_OFFSET) + 0x104)
...
#define MSDC_IOCON_R_D_SMPL_SEL         (((UINT32)0x01) << MSDC_IOCON_R_D_SMPL_SEL_SHIFT)
...
#define MSDC_IOCON_W_D_SMPL_SEL_SEL     (((UINT32)0x01) << MSDC_IOCON_W_D_SMPL_SEL_SHIFT)
...
#define INT_AUTOCMD19_DONE              (((UINT32)0x01) << 16)
#define INT_BD_CS_ERR                   (((UINT32)0x01) << 17)
#define INT_GPD_CS_CRCERR               (((UINT32)0x01) << 18)
#define INT_DMA_PROTECT                 (((UINT32)0x01) << 19)
...
#define SDC_CMD_AUTO_CMD23              (((UINT32)0x2) << 28)  
...
/* Host OCR */
#define BUSY_MASK               ((UINT32)(0x1<<31))
#define HCS_MASK                ((UINT32)(0x1<<30))
#define CCS_MASK                ((UINT32)(0x1<<30))
#define XPC_MASK                ((UINT32)(0x1<<28))
#define S18R_MASK               ((UINT32)(0x1<<24))
#define S18A_MASK               ((UINT32)(0x1<<24))
#define OCR_MASK                ((UINT32)(0xFF8000))
#if defined(CC_MT5399) || defined(CONFIG_ARCH_MT5399)|| \
    defined(CC_MT5890) || defined(CONFIG_ARCH_MT5890)|| \
    defined(CC_MT5882) || defined(CONFIG_ARCH_MT5882)
#define HOST_OCR_ATTRIBUTE      (HCS_MASK | XPC_MASK | S18R_MASK)
#define HOST_OCR_VOLTAGE        (OCR_MASK)
#else
#define HOST_OCR_ATTRIBUTE      (HCS_MASK)
#define HOST_OCR_VOLTAGE        (OCR_MASK)
#endif
#define HOST_OCR                (HOST_OCR_ATTRIBUTE | HOST_OCR_VOLTAGE)
