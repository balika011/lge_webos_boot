...
#endif
#define I2CLOG(fmt, arg...)   dbg_print(I2CTAG fmt, ##arg)
#define I2CMSG(fmt, arg...)   dbg_print(fmt, ##arg)
#define I2CERR(fmt, arg...)   dbg_print(I2CTAG "%d: "fmt, __LINE__, ##arg)
#define I2CFUC(fmt, arg...)   dbg_print(I2CTAG "%s\n", __FUNCTION__)
...
//#define I2C_DRIVER_IN_KERNEL
  ...
  #else
    #define I2C_CLK_RATE		  12350 	/* kHz for FPGA I2C work frequency */
  #endif
...
//==============================================================================
extern S32 mt_i2c_set_speed (U8 channel,U8 clock, I2C_SPEED_MODE mode, U8 khz);
extern S32 mt_i2c_read(U8 channel,U8 addr,U8 *buffer, U32 len, U8 dir);
extern S32 mt_i2c_write(U8 channel,U8 addr,U8 *buffer, U32 len, U8 dir);
extern S32 mt_i2c_read_new(struct mt_i2c_t *i2c,U8 *buffer, U32 len);
extern S32 mt_i2c_write_new(struct mt_i2c_t *i2c,U8  *buffer, U32 len);
extern S32 mt_i2c_write_read_new(struct mt_i2c_t *i2c,U8 *buffer, U32 write_len, U32 read_len);
