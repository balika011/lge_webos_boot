...
INT32 rm_init(void);
INT32 rm_open(
    DRV_COMP_REG_T  *pt_comp_reg,
    UINT32 *pui4_flags,
    DRV_COMP_FCT_TBL_T **ppt_comp_fct_tbl,
    const VOID **ppv_comp_data,
    SIZE_T *pz_comp_data_len
);
