...
#if defined(CC_MWIF2) || defined(CC_FPGA_SUPPORT)
    #define ASSERT(x)		((void)0)
    #define VERIFY(x)		((void)(x))
#else
	#ifdef CUST_SOEM_DRV// need to remove!!
	#define ASSERT(x)		((void)0)//((x) ? (void)0 : Assert(#x, __FILE__, (INT32)__LINE__))
	#define VERIFY(x)		((void)(x))//((x) ? (void)0 : Assert(#x, __FILE__, (INT32)__LINE__))
	#else
