...
#define MUSB_SERIAL_TIMER_IDX  (MUSB_HID_TIMER_IDX + MUSB_HID_TIMER)
#define MUSB_SERIAL_TIMER  1 /*Use for delay in mu_hid.c after config serial device*/

#define MUSB_BT_TIMER_IDX  (MUSB_SERIAL_TIMER_IDX + MUSB_SERIAL_TIMER)
...
/** Required task stack size for this target */
#define MUSB_UCOS_TASK_PRIORITY        (50)  //(60)
