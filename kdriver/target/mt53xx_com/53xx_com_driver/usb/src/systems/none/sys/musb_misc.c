...
//---------------------------------------------------------------------------
#if defined(CONFIG_ARCH_MT85XX)
extern void vIrqOn(UINT32 dSource);
extern void vIrqOff(UINT32 dSource);
extern void vIrq1On(UINT32 dIrqs);
extern void vIrq1Off(UINT32 dIrqs);
extern UINT32 dIrq1MaskEx(void); 
#endif
...
{
    if (dIrq1MaskEx() & ((UINT32)0x1 << u4Vector))
    {
        return TRUE;
    }
    else
