...
#define MGC_PHY_Read32(_pBase, r) (\
	...
	*((volatile uint32_t *)((MUSB_BASE + MUSB_PHYBASE)+ (MUSB_PORT0_PHYBASE) + (r))):\
	(((uint32_t)_pBase == (MUSB1_BASE))?\
	*((volatile uint32_t *)((MUSB_BASE + MUSB_PHYBASE)+ (MUSB_PORT1_PHYBASE) + (r))):\
	*((volatile uint32_t *)((MUSB2_BASE + MUSB_PHYBASE)+ (MUSB_PORT0_PHYBASE) + (r))))\
	)
...
#define MGC_PHY_Write32(_pBase, r, v) { \
    ...
    *((volatile uint32_t *)((MUSB2_BASE + MUSB_PHYBASE)+ (MUSB_PORT0_PHYBASE) + (r))) = v;\
    Printf("USB PHY@0x%08X = 0x%08X\n", ((uint32_t)((MUSB2_BASE + MUSB_PHYBASE)+(MUSB_PORT0_PHYBASE) + (r))), (uint32_t)v);\
    }\
}
//#endif
#else
