...
#if defined(CONFIG_ARCH_MT85XX)
static inline UINT32 musb_get_phys(UINT32 address)
{
     return (UINT32)virt_to_phys((void *)address);
}

static inline UINT32 musb_get_virt(UINT32 address)
{	
    return (UINT32)phys_to_virt((unsigned long)address);
}
...
#define U_PHY_ADDR musb_get_phys
#define U_VIRT_ADDR musb_get_virt
...
#else
#define TGPD_SET_NEXT(_pd, _next)   ((TGPD *)(_pd))->pNext = (TGPD *)(U_PHY_ADDR((UINT32)(_next)));
#define TGPD_GET_NEXT(_pd)          (TGPD *)(U_VIRT_ADDR((UINT32)((TGPD *)(_pd))->pNext))
#define TGPD_SET_DATA(_pd, _data)   ((TGPD *)(_pd))->pBuf = (BYTE *)(U_PHY_ADDR((UINT32)(_data)))
#define TGPD_GET_DATA(_pd)          (BYTE*)(U_VIRT_ADDR((UINT32)((TGPD *)(_pd))->pBuf))
#endif
...
#if defined(CONFIG_ARCH_MT85XX)
#define PHY_TGPD_SET_NEXT(_pd, _next)   ((TGPD *)(_pd))->pNext = (TGPD *)((UINT32)(_next));
#define PHY_TGPD_GET_NEXT(_pd)          (TGPD *)((UINT32)((TGPD *)(_pd))->pNext)
#define PHY_TGPD_SET_DATA(_pd, _data)   ((TGPD *)(_pd))->pBuf = (BYTE *)((UINT32)(_data))
#define PHY_TGPD_GET_DATA(_pd)          (BYTE*)((UINT32)((TGPD *)(_pd))->pBuf)
#endif
