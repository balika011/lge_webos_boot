...
#else //#if !defined (CONFIG_ARCH_MT85XX)
#define MUSB_IRP_QUEUE_LENGTH   64//sarick modify(16) /* double-buffered, all endpoints both directions */
#endif //#if !defined (CONFIG_ARCH_MT85XX)
#endif
...
#if defined (CONFIG_ARCH_MT85XX)
#define MGC_BSR_CAUSE_DPDM_INTR	0x04
#endif
 ...
 */
typedef struct _MGC_EndpointResource
{
...
#if defined (CONFIG_ARCH_MT85XX)
typedef uint32_t (*MGC_pfPdwncPort)(struct _MGC_Port*, uint32_t);
#endif
