...
typedef CRYPTO_BOOL ec_exponentiation_t(const digit_t *, const digit_t *, const CRYPTO_DWORD,
...
typedef struct ecurve_t {
             ...
             CRYPTO_BOOL               free_field; // Flag telling ec_free to call
                                            // Kfree.  For system use only.
             CRYPTO_BOOL               biszero;    // Is b == 0?
             CRYPTO_DWORD           ndigtemps;  // Number of digit_t temporaries
                                            // needed by EC
                                            ...
                                            // (or Kmuladd, etc.)
                                            // in the base field.
             CRYPTO_DWORD           lnggorder;  // Number of significant words
...
CRYPTO_BOOL ecaffine_addition
      (const digit_t *, const digit_t *, digit_t *,
       const CRYPTO_INT, const struct ecurve_t*, digit_t *, struct bigctx_t *f_pBigCtx);
...
CRYPTO_BOOL ecaffine_exponentiation
          (const digit_t *, const digit_t *, const CRYPTO_DWORD, digit_t *,
           const struct ecurve_t*, struct bigctx_t *f_pBigCtx);

CRYPTO_BOOL ecaffine_is_infinite(const digit_t *, const struct ecurve_t*, struct bigctx_t *f_pBigCtx);

CRYPTO_BOOL ecaffine_multiply_pm1
          (const digit_t *, digit_t *, const CRYPTO_INT, const struct ecurve_t*, struct bigctx_t *f_pBigCtx);

CRYPTO_BOOL ecaffine_negate(const digit_t *, digit_t *,
                                   const struct ecurve_t*, struct bigctx_t *f_pBigCtx);

CRYPTO_BOOL ecaffine_on_curve(const digit_t *, const struct ecurve_t*,
                                     const CRYPTO_CHAR*, digit_t *, struct bigctx_t *f_pBigCtx);

CRYPTO_BOOL ecaffine_PPQ(const digit_t *, const digit_t *,
                                digit_t *, const CRYPTO_INT,
                                const struct ecurve_t*, digit_t *, struct bigctx_t *f_pBigCtx);

CRYPTO_BOOL ecaffine_random(digit_t *, const struct ecurve_t*,
                                   digit_t *, struct bigctx_t *f_pBigCtx);

CRYPTO_BOOL ecaffine_set_infinite(digit_t *,
                                         const struct ecurve_t*, struct bigctx_t *f_pBigCtx);

CRYPTO_BOOL ec_initialize(const digit_t *, const digit_t *,
                                const field_desc_t*, struct ecurve_t*, struct bigctx_t *f_pBigCtx, struct bigctx_t*);

CRYPTO_BOOL ec_free(struct ecurve_t*, struct bigctx_t *f_pBigCtx);     // IN/OUT

extern CRYPTO_BOOL ecaffine_exponentiation_tabular
          (const digit_t *, const CRYPTO_DWORD, const CRYPTO_DWORD, const digit_t *,
           const CRYPTO_DWORD, digit_t *, const struct ecurve_t*, struct bigctx_t *f_pBigCtx);

CRYPTO_BOOL ecaffine_table_construction(const digit_t *, const CRYPTO_DWORD,
                                               const CRYPTO_DWORD, digit_t *,
                                               const struct ecurve_t*, struct bigctx_t *f_pBigCtx);
