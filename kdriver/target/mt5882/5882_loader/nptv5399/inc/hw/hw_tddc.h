...
#define IO_TDDC_BASE (IO_VIRT+0x36000)


//Page TDDC
#define TDDC_00 (IO_TDDC_BASE + 0xE00)
...
#define TDDC_01 (IO_TDDC_BASE + 0xE04)
...
#define TDDC_04 (IO_TDDC_BASE + 0xE10)
    #define C_TDDC_MV_END_ADR Fld(24,0,AC_MSKDW)//[23:0]
#define TDDC_05 (IO_TDDC_BASE + 0xE14)
    #define C_TDDC_SA_STR_ADR_L Fld(24,0,AC_MSKDW)//[23:0]
#define TDDC_06 (IO_TDDC_BASE + 0xE18)
    #define C_TDDC_SA_STR_ADR_R Fld(24,0,AC_MSKDW)//[23:0]
#define TDDC_07 (IO_TDDC_BASE + 0xE1C)
    #define C_TDDC_MV_RD_STR_ADR Fld(24,0,AC_MSKDW)//[23:0]
#define TDDC_08 (IO_TDDC_BASE + 0xE20)
    #define C_TDDC_DBG_SEL Fld(4,17,AC_MSKB2)//[20:17]
    #define SAMPLE_MV_EN Fld(1,16,AC_MSKB2)//[16:16]
    #define SAMPLE_BLK_X Fld(7,8,AC_MSKB1)//[14:8]
    #define SAMPLE_BLK_Y Fld(7,0,AC_MSKB0)//[6:0]
#define TDDC_STATUS1 (IO_TDDC_BASE + 0xE30)
    ...
    #define RD_CUR_BLK_X Fld(8,20,AC_MSKW32)//[27:20]
    #define RD_CUR_BLK_Y Fld(8,12,AC_MSKW21)//[19:12]
...
#define TDDC_STATUS2 (IO_TDDC_BASE + 0xE34)
...
#define TDDC_ATPG (IO_TDDC_BASE + 0xE3C)
...
//Page TDDCDS
#define TDDCDS_00 (IO_TDDC_BASE + 0xE40)
    #define C_DIA_OB_MODE Fld(1,27,AC_MSKB3)//[27:27]
    #define C_DV_MODE Fld(2,25,AC_MSKB3)//[26:25]
    #define C_ORD_OB_MODE Fld(1,21,AC_MSKB2)//[21:21]
    #define C_OBDE_MODE Fld(1,20,AC_MSKB2)//[20:20]
    #define C_ORD_CORING Fld(4,16,AC_MSKB2)//[19:16]
    #define C_ORD_TH Fld(8,8,AC_FULLB1)//[15:8]
    #define C_ORD_PNLTY_SEL Fld(4,4,AC_MSKB0)//[7:4]
    #define C_DV_CAND_NUM Fld(4,0,AC_MSKB0)//[3:0]
#define TDDCDS_01 (IO_TDDC_BASE + 0xE44)
    #define C_SM_DV_PNLTY_STN Fld(1,31,AC_MSKB3)//[31:31]
    #define C_SM_DV_TH2 Fld(4,22,AC_MSKW32)//[25:22]
    #define C_SM_DV_TH Fld(8,14,AC_MSKW21)//[21:14]
    #define C_SM_DV_VAR_SEL Fld(2,12,AC_MSKB1)//[13:12]
    #define C_SM_DV_ADA_BASE Fld(4,8,AC_MSKB1)//[11:8]
    #define C_SM_DV_Y_PNLTY_SEL Fld(4,4,AC_MSKB0)//[7:4]
    #define C_SM_DV_X_PNLTY_SEL Fld(4,0,AC_MSKB0)//[3:0]
#define TDDCDS_02 (IO_TDDC_BASE + 0xE48)
    #define C_REFINE_PNLTY_SEL Fld(4,28,AC_MSKB3)//[31:28]
...
#define TDDCDS_03 (IO_TDDC_BASE + 0xE4C)
    #define C_RAND_COST Fld(6,24,AC_MSKB3)//[29:24]
...
#define TDDCDS_05 (IO_TDDC_BASE + 0xE54)
...
#define TDDCDS_06 (IO_TDDC_BASE + 0xE58)
...
#define TDDCDS_07 (IO_TDDC_BASE + 0xE5C)
...
#define TDDCDS_11 (IO_TDDC_BASE + 0xE6C)
...
#define TDDCDS_12 (IO_TDDC_BASE + 0xE70)
...
#define TDDCDS_13 (IO_TDDC_BASE + 0xE74)
    #define STA_VAR_FRM_R Fld(16,16,AC_FULLW32)//[31:16]
    #define STA_VAR_FRM_L Fld(16,0,AC_FULLW10)//[15:0]
#define TDDCDS_15 (IO_TDDC_BASE + 0xE7C)
    #define C_SM_LUMA_TH2 Fld(4,22,AC_MSKW32)//[25:22]
    #define C_SM_LUMA_TH Fld(8,14,AC_MSKW21)//[21:14]
    #define C_SM_LUMA_VAR_SEL Fld(2,12,AC_MSKB1)//[13:12]
    #define C_SM_LUMA_ADA_BASE Fld(4,8,AC_MSKB1)//[11:8]
    #define C_SM_LUMA_Y_PNLTY_SEL Fld(4,4,AC_MSKB0)//[7:4]
    #define C_SM_LUMA_X_PNLTY_SEL Fld(4,0,AC_MSKB0)//[3:0]
#define TDDCDS_16 (IO_TDDC_BASE + 0xE80)
    #define RAND_DV4 Fld(6,18,AC_MSKB2)//[23:18]
    #define RAND_DV3 Fld(6,12,AC_MSKW21)//[17:12]
    #define RAND_DV2 Fld(6,6,AC_MSKW10)//[11:6]
    #define RAND_DV1 Fld(6,0,AC_MSKB0)//[5:0]
#define TDDCDS_17 (IO_TDDC_BASE + 0xE84)
    #define C_DMAP_INTPL_STRNGTH Fld(4,11,AC_MSKB1)//[14:11]
    #define C_DMAP_FILTER_STRNGTH Fld(4,7,AC_MSKW10)//[10:7]
    #define C_V_EDGE_THR Fld(7,0,AC_MSKB0)//[6:0]
#define TDDCDS_18 (IO_TDDC_BASE + 0xE88)
    #define SEL_STA_PBOX Fld(1,31,AC_MSKB3)//[31:31]
    #define PBOX_STR_X Fld(12,12,AC_MSKW21)//[23:12]
    #define PBOX_END_X Fld(12,0,AC_MSKW10)//[11:0]
#define TDDCDS_19 (IO_TDDC_BASE + 0xE92)
    #define PBOX_STR_Y Fld(12,12,AC_MSKW21)//[23:12]
    #define PBOX_END_Y Fld(12,0,AC_MSKW10)//[11:0]
#define TDDCDS_ATPG (IO_TDDC_BASE + 0xEDC)
    #define C_TDDCDS_RESERVED Fld(30,2,AC_MSKDW)//[31:2]
    #define C_GMV_X1_R Fld(10,8,AC_MSKW21)
    #define C_GMV_Y1_R Fld(6,2,AC_MSKB0)
    #define TDDCDS_ATPG_OB Fld(1,1,AC_MSKB0)//[1:1]
    #define TDDCDS_ATPG_CT Fld(1,0,AC_MSKB0)//[0:0]

//Page TDDCDV
#define TDDCDV_00 (IO_TDDC_BASE + 0xEE0)
    #define C_TTD_FSAMPLE_ENABLE Fld(1,8,AC_MSKB1)//[8:8]
    #define C_TTD_CONVERGENCE_DEPTH Fld(8,0,AC_FULLB0)//[7:0]
#define TDDCDV_01 (IO_TDDC_BASE + 0xEE4)
    #define C_TTD_OUT_LR_DLY Fld(2,15,AC_MSKW21)//[16:15]
    #define STA_DMAP_ERR_OVER Fld(1,5,AC_MSKB0)//[5:5]
#define TDDCDV_ATPG (IO_TDDC_BASE + 0xEFC)
