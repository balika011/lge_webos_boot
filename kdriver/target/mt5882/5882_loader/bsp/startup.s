...
INT_Reset
    ...
    ;LDR     r0, =0x410FB764 ; Check ARM11 ID, 5395 is 0x410FB767
    ;CMP     r0, r1
    ;BNE     NoRemapPPort
    ...
    BIC     r0, r0, #CR_MMU
    ORR     r0, r0, #CR_BPRDCT
    ORR     r0, r0, #CR_UNALIGNMENT_SUPPORT
...
;    LDR     r0, =0xf00081f0             ; check ic version
;    LDR     r1, [r0]
;    LDR     r0, =0x53950000
;    CMP     r0, r1
;    BNE     EnableFifo
    LDR     r0, =0xf0008110             ; disable write fifo
    LDR     r1, =0x0
    STR     r1, [r0]
EnableFifo
    BX      lr
