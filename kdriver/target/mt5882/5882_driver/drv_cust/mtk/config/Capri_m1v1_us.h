...
//----------------------------------------------------------------------------
    ...
    #define PART_KERNEL_SIZE                (4*1024*1024)
        ...
        #else
            #define PART_ROOTFS_SIZE        (40*1024*1024)
        #endif
    ...
    #define PART_ACFG_DESC_SIZE             (256*1024)
    ...
    #define SDM_TOTAL_SIZE \
                           (PART_CHANNEL_SIZE + PART_CHANNEL_SIZE + \
                            ...
                            PART_SCHED_PVR_SIZE + PART_ADSP_SIZE + \
                            PART_RESERV_SIZE + PART_RESERV_SIZE + \
                            PART_SDM_BAD_SECTOR_SIZE + PART_ACFG_DESC_SIZE)
    ...
    #define NAND_PART_SIZE_21               (PART_RESERV_SIZE)              /* nand_21 - reserved     */
    #define NAND_PART_SIZE_22               (PART_RESERV_SIZE)              /* nand_22 - reserved     */ 
