...
#define FBM_MEM_CFG_MT5882_3DTV             FBM_ALIGN_MASK(FBM_SIZE_FORMULAR(0x20000),4095)
#else
#define FBM_MEM_CFG_MT5882_3DTV             FBM_ALIGN_MASK(FBM_SIZE_FORMULAR(0x20000),4095)
#endif
