...
#else
#define LINUX_MM_VFY_RESERVE_SIZE           (512*1024*1024)
#define LINUX_KERNEL_MEM_SIZE               (TOTAL_MEM_SIZE - LINUX_MM_VFY_RESERVE_SIZE)
#endif
...
//----------------------------------------------------------------------------
    ...
    #define NAND_PART_SIZE_17               (PART_CI_SIZE)                  /* nand_17 - ci              */
    #define NAND_PART_SIZE_18               (PART_DEFAULT_DB_SIZE)          /* nand_18 - DVBS default db */
    #define NAND_PART_SIZE_19               (PART_ADSP_SIZE)                /* nand_19 - audio dsp        */
    ...
    #ifdef ADSP_BIN_SUPPORT
        #define FLASH_ADSP_BIN_PARTITION                (19)
        #define NAND_PART_NAME_19           "adsp"
