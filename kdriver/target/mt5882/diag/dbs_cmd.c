...
static VOID _DbsAudMessages(VOID)
{
    ...
    if (AUD_IsDecoderPlay(AUD_DSP0, AUD_DEC_MAIN) || AUD_IsDecoderPlay(AUD_DSP0, AUD_DEC_AUX))
#else
...
#endif    	
    {
        ...
        {
#ifdef CC_AUD_SUPPORT_DUAL_DSP        
            if (AUD_IsDecoderPlay(AUD_DSP0, i4Idx))
            {
                AUD_GetStreamInfo(AUD_DSP0, i4Idx, &u1Acmode, &u1SmpRate, &u4DataRate);
#else
