...
#define x_sb_mem_alloc(size)                        x_sb_lm_mem_alloc(size, __FILE__, __LINE__, __func__)  /**<sb memory alloc        */
#define x_sb_mem_free(pv_mem_block)                 x_sb_lm_mem_free(pv_mem_block)    /**<sb memory free        */        
#define x_sb_mem_realloc(pv_mem_block, z_size)      x_mem_realloc(pv_mem_block,z_size)    /**<sb memory reallocate */
...
VOID x_sb_set_secure_log(BOOL b_on);

BOOL x_sb_get_secure_log(VOID);
