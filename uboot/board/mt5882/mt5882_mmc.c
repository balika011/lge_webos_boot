...
const EMMC_FLASH_DEV_T _arEMMC_DevInfo[] =
{
  ...
  {"H26M52103FMR",         	  0x4A484147, 0x32650502, 0x00000000, 0x00000000, 0x00000006, 0x00000F0F, 0x00000002, 0x00040F0F, 0x00000100, 0x04150917},
  ...
  {"THGBMBG5D1KBAIL",   	  0x00303034, 0x47453000, 0x00000000, 0x00000000, 0x00000006, 0x00000F0F, 0x00000102, 0x0000130F, 0x00011500, 0x01150001},
  ...
  {"THGBMBG6D1KBAIL-XXX",	  0x00303038, 0x47453000, 0x00000000, 0x00000000, 0x00000006, 0x00000000, 0x00000102, 0x0000130F, 0x00000002, 0x030E090C},
};
...
{ 
    ...
    defined(CC_MT5861) || defined(CONFIG_ARCH_MT5861)
    	MSDC_CLRBIT(PAD_TUNE, 0xFFFFFFFF);
        MSDC_SETBIT(PAD_TUNE, _arEMMC_DevInfo[devIndex].HS200Delay&0x0000ffff);//PAD_DAT_RD_RXDLY,PAD_DAT_WR_RXDLY

        MSDC_CLRBIT(PAD_TUNE, PAD_CLK_TXDLY);
   	    MSDC_SETBIT(PAD_TUNE, 0x8<<PAD_CLK_TXDLY_SHIFT);
   	    
        MSDC_CLRBIT(PATCH_BIT1, 0x7);//WRDAT_CRCS_TA_CNTR
...
*/
    	...
    	MSDC_CLRBIT(MSDC_IOCON, MSDC_IOCON_W_D0SPL);
   	    MSDC_SETBIT(MSDC_IOCON, ((_arEMMC_DevInfo[devIndex].HS200Delay&0xff000000)>>24)<<MSDC_IOCON_W_D0SPL_SHIFT); //
