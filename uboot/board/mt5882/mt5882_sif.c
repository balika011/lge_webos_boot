...
int dual_bank_init (void)
{
    ...
    if((rDtvCfg.u1Flags3 & DTVCFG_FLAG3_ROOTFS_BANK) == DTVCFG_FLAG3_ROOTFS_BANK)
    {
        u1blocknum = MTDPARTS_NUM_OF_ROOTFS_B;
    }
    else
    {
        u1blocknum = MTDPARTS_NUM_OF_ROOTFS_A;
    }
    #if defined(CC_TWO_WORLD_RFS)
