...
ifeq "$(SECURE_BOOT)" "y"
export CC_SECURE_ROM_DEF = -DCC_SECURE_ROM_BOOT -DCC_A1_SECURE_BOOT
export SECURE_CUSTKEY=y
endif
...
COMMON_INC = -I. \
             -I$(ROOTDIR)/drv_lib/include \
             -I$(ROOTDIR)/drv_lib/drv_inc \
             -I$(ROOTDIR)/drv_lib/inc \
             -I$(ROOTDIR)/drv_lib/drv_cust
...
ifeq "$(L_ENV)" "true"
OSAI_INC =     -I. \
               -I$(ROOTDIR)/drv_lib/x_inc \
               -I$(ROOTDIR)/drv_lib/nptv/inc \
               -I$(ROOTDIR)/drv_lib/nptv/inc/hw \
               -I$(ROOTDIR)/drv_lib/nptv/inc/drv \
               -I$(ROOTDIR)/drv_lib/nptv/inc/sys \
