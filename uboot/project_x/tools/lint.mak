...
%.lint : %.c
	@echo ""
	@echo "---------------- Checking $< ----------------"
	$(call if_dir_not_exist_fct,$(call path_cnvt,$(TOOL_LINT_DIR)), \
	    $(MKDIR) $(MKDIR_FLAG) $(call path_cnvt,$(TOOL_LINT_DIR)) || exit 1 ;)
	@$(LINT) $(LINT_FLAG) $(call inc_path_cnvt,$(ABS_INCLUDE)) $(ABS_DEFINES) $(call path_cnvt,$<) > $(call path_cnvt,$(TOOL_LINT_DIR)/$@) || exit 0
	@$(CAT) $(CAT_FLAG) $(call path_cnvt,$(TOOL_LINT_DIR)/$@)
