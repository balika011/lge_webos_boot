...
typedef enum
{
    ...
    E_INT_IPI_0x130_START               = 0x130,
    E_INT_IPI_NUM_0                     = E_INT_IPI_0x130_START + 0,
    E_INT_IPI_NUM_1                     = E_INT_IPI_0x130_START + 1,
    E_INT_IPI_NUM_2                     = E_INT_IPI_0x130_START + 2,
    E_INT_IPI_NUM_3                     = E_INT_IPI_0x130_START + 3,
    E_INT_IPI_NUM_4                     = E_INT_IPI_0x130_START + 4,
    E_INT_IPI_NUM_5                     = E_INT_IPI_0x130_START + 5,
    E_INT_IPI_NUM_6                     = E_INT_IPI_0x130_START + 6,
    E_INT_IPI_NUM_7                     = E_INT_IPI_0x130_START + 7,
    E_INT_IPI_NUM_8                     = E_INT_IPI_0x130_START + 8,
    E_INT_IPI_NUM_9                     = E_INT_IPI_0x130_START + 9,
    E_INT_IPI_NUM_10                    = E_INT_IPI_0x130_START + 10,
    E_INT_IPI_NUM_11                    = E_INT_IPI_0x130_START + 11,
    E_INT_IPI_NUM_12                    = E_INT_IPI_0x130_START + 12,
    E_INT_IPI_NUM_13                    = E_INT_IPI_0x130_START + 13,
    E_INT_IPI_NUM_14                    = E_INT_IPI_0x130_START + 14,
    E_INT_IPI_NUM_15                    = E_INT_IPI_0x130_START + 15,
    E_INT_IPI_0x130_END                 = 0x13F,
} InterruptNum;
