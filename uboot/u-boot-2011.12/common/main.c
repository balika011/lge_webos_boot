...
#if defined(CONFIG_BOOTDELAY) && (CONFIG_BOOTDELAY >= 0)
	s = getenv ("bootdelay");
#ifdef CFG_LG_CHG //temp
	bootdelay = 0; //s ? (int)simple_strtol(s, NULL, 10) : CONFIG_BOOTDELAY;
#else
...
# endif	/* CONFIG_BOOT_RETRY_TIME */
	...
	if (bootlimit && (bootcount > bootlimit)) {
		...
		if(BIM_CheckFastboot())
		{
		    ...
		    sprintf(newstr, "%8x%8x", (*((volatile u32*)(ETHERNET_BASE1)) | 0x80000000),(*((volatile u32*)(ETHERNET_BASE2))) | 0x80000000);
